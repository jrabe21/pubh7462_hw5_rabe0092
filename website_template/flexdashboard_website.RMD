...
shot_per_gg <- lakers.df %>%
  ...
  ggplot(aes(x = date, y = sht_pct, colour = type)) +
...
#ggplotly() + tooltip to control label
ggplotly(shot_per_gg, tooltip = "text") #tooltip controls text hover/label
```
